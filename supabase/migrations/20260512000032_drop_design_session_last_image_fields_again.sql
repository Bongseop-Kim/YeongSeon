drop function if exists public.save_design_session(uuid, text, text, text, text, text, jsonb, text, text, text, text, jsonb, text, text);

alter table public.design_chat_sessions
  drop column if exists last_image_url,
  drop column if exists last_image_file_id,
  drop column if exists last_image_work_id;
...
comment on function public.save_design_session(uuid, text, text, jsonb, text, text, text, text, jsonb, text, text)
...
grant execute on function public.save_design_session(uuid, text, text, jsonb, text, text, text, text, jsonb, text, text)
  to authenticated;
