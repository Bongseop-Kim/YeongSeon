...
comment on function public.save_design_session(uuid, text, text, text, text, text, jsonb, text, text, text, text, text, text)
...
grant execute on function public.save_design_session(uuid, text, text, text, text, text, jsonb, text, text, text, text, text, text)
  to authenticated;
