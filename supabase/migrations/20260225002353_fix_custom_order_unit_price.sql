-- Fix: create_custom_order_txn was setting unit_price = v_total_cost with
-- quantity = p_quantity, which double-counts because v_total_cost already
-- incorporates p_quantity via calculate_custom_order_amounts.
-- Set quantity = 1 so that unit_price * quantity = v_total_cost.
