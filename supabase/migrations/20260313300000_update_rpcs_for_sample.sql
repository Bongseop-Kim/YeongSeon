-- =============================================================
-- Update RPCs and views for sample order workflow
-- =============================================================

-- ── 1. calculate_custom_order_amounts: add p_sample + sample_cost ──
...
-- ── 2. create_custom_order_txn: sample_cost 처리 추가 ──
...
-- ── 5. calculate_refund_amount: 신규 RPC ──
...
-- ── 6. admin_order_list_view: isSample, sampleType 추가 ──
...
-- ── 7. admin_order_detail_view: sample_cost 추가 ──
-- CREATE OR REPLACE VIEW는 새 컬럼을 맨 끝에만 추가할 수 있으므로 sampleCost를 마지막에 배치
