...
export interface RadioSelectBoxRootProps
  extends SeedRadioGroupField.RootProps, SelectBoxGroupVariantProps {
        ...
        {(label || indicator) && (
          <SeedRadioGroupField.Header>
            <SeedRadioGroupField.Label weight={labelWeight}>
              {label}
              {showRequiredIndicator && (
                <SeedRadioGroupField.RequiredIndicator />
              )}
              {indicator && (
                <SeedRadioGroupField.IndicatorText>
                  {indicator}
                </SeedRadioGroupField.IndicatorText>
              )}
            ...
            {description &&
              (renderErrorMessage ? (
                <VisuallyHidden asChild>
                  <SeedRadioGroupField.Description>
                    {description}
                  </SeedRadioGroupField.Description>
                </VisuallyHidden>
              ) : (
...
export interface RadioSelectBoxItemProps extends Omit<
  SeedRadioSelectBox.ItemProps,
  "children"
> {
  label: React.ReactNode;
  description?: React.ReactNode;
  ...
  (
    ...
    return (
      <SeedRadioSelectBox.Item ref={rootRef} {...otherProps}>
        ...
        {footer && (
          <SeedRadioSelectBox.Footer>{footer}</SeedRadioSelectBox.Footer>
        )}
...
export interface CheckSelectBoxGroupProps
  extends SeedFieldset.RootProps, SelectBoxGroupVariantProps {
  label?: React.ReactNode;
  /**
   * @default "medium"
   */
...
export interface CheckSelectBoxProps extends Omit<
  SeedCheckSelectBox.RootProps,
  "children"
> {
  label: React.ReactNode;
  description?: React.ReactNode;
  ...
  (
    ...
    return (
      <SeedCheckSelectBox.Root ref={rootRef} {...otherProps}>
        ...
        {footer && (
          <SeedCheckSelectBox.Footer>{footer}</SeedCheckSelectBox.Footer>
        )}
...
export type CheckSelectBoxCheckmarkProps =
  SeedCheckSelectBox.CheckmarkControlProps;
