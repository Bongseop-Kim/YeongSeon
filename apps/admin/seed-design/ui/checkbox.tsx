...
export interface CheckboxGroupProps
  extends SeedFieldset.RootProps, CheckboxGroupVariantProps {
      ...
      <SeedCheckbox.Root ref={rootRef} {...otherProps}>
        <SeedCheckbox.Control>
          <SeedCheckbox.Indicator
            unchecked={
              otherProps.variant === "ghost" ? <IconCheckmarkFatFill /> : null
            }
  ...
  (props, ref) => {
    return (
      <SeedCheckbox.Control ref={ref} {...props}>
        <SeedCheckbox.Indicator
          unchecked={
            props.variant === "ghost" ? <IconCheckmarkFatFill /> : null
          }
          checked={<IconCheckmarkFatFill />}
          indeterminate={<IconMinusFatFill />}
        />
