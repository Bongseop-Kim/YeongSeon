...
export interface FieldButtonProps extends Omit<
  SeedFieldButton.RootProps,
  "prefix"
> {
...
>(
  (
    ...
    if (
      ...
      console.warn(
        "FieldButton: aria-labelledby or aria-label should be provided to buttonProps.",
      );
    }
    ...
    return (
      <SeedFieldButton.Root ref={rootRef} {...otherProps}>
        ...
        <SeedFieldButton.Control>
          ...
          {prefix && (
            <SeedFieldButton.PrefixText>{prefix}</SeedFieldButton.PrefixText>
          )}
          {children}
          {showClearButton && (
          ...
          {suffix && (
            <SeedFieldButton.SuffixText>{suffix}</SeedFieldButton.SuffixText>
          )}
