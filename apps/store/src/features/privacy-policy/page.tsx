import { PolicyPageLayout, PolicySection, PolicyList, PolicyInfoBox } from "@/features/policy/components/policy-components";
  ...
  return (
    <PolicyPageLayout title="개인정보처리방침">
        <PolicySection title="1. 개인정보의 처리 목적">
          <p>
            ESSE SION은 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고
          ...
          <PolicyList>
            <li>
              홈페이지 회원 가입 및 관리: 회원 가입의사 확인, 회원제 서비스
            ...
            <li>
              마케팅 및 광고에의 활용: 신규 서비스(제품) 개발 및 맞춤 서비스
              제공, 이벤트 및 광고성 정보 제공 및 참여기회 제공
            </li>
          </PolicyList>
        </PolicySection>

        <PolicySection title="2. 개인정보의 처리 및 보유기간">
          <p>
            ESSE SION은 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터
        ...
        <PolicySection title="3. 처리하는 개인정보의 항목">
          <p>ESSE SION은 다음의 개인정보 항목을 처리하고 있습니다.</p>
          <PolicyList>
            <li>필수항목: 이름, 이메일, 비밀번호, 전화번호, 배송지 주소</li>
            <li>선택항목: 생년월일, 성별</li>
            <li>
              자동 수집 항목: IP주소, 쿠키, MAC주소, 서비스 이용 기록, 방문
              기록, 불량 이용 기록 등
            </li>
          </PolicyList>
        </PolicySection>
        ...
        <PolicySection title="4. 개인정보의 제3자 제공">
          <p>
            ESSE SION은 정보주체의 개인정보를 제1조(개인정보의 처리 목적)에서
        ...
        <PolicySection title="5. 개인정보처리의 위탁">
          <p>
            ESSE SION은 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보
            처리업무를 위탁하고 있습니다.
          </p>
          <PolicyList>
            <li>
              배송 서비스: 배송 업체에 배송에 필요한 최소한의 정보(이름,
              전화번호, 주소) 제공
            </li>
            <li>결제 서비스: 결제 대행 업체에 결제에 필요한 정보 제공</li>
          </PolicyList>
        </PolicySection>

        <PolicySection title="6. 정보주체의 권리·의무 및 그 행사방법">
          <p>
            정보주체는 ESSE SION에 대해 언제든지 다음 각 호의 개인정보 보호 관련
            권리를 행사할 수 있습니다.
          </p>
          <PolicyList>
            <li>개인정보 처리정지 요구권</li>
        ...
        <PolicySection title="7. 개인정보의 파기">
          <p>
            ESSE SION은 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가
            불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.
          </p>
          <p className="mt-2">파기의 절차 및 방법은 다음과 같습니다.</p>
          <PolicyList>
            <li>
        ...
        <PolicySection title="8. 개인정보 보호책임자">
          <p>
            ESSE SION은 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보
        ...
        <PolicySection title="9. 개인정보 처리방침 변경">
          <p>
