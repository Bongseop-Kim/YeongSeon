  ...
  return (
    <PolicyPageLayout title="개인정보처리방침">
      <PolicySection title="1. 개인정보의 처리 목적">
        <p>
          ESSE SION은 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는
        ...
        <PolicyList>
          <li>
            홈페이지 회원 가입 및 관리: 회원 가입의사 확인, 회원제 서비스 제공에
      ...
      <PolicySection title="3. 처리하는 개인정보의 항목">
        ...
        <PolicyList>
          ...
          <li>선택항목: 생년월일, 성별</li>
          <li>
            자동 수집 항목: IP주소, 쿠키, MAC주소, 서비스 이용 기록, 방문 기록,
            불량 이용 기록 등
          </li>
        </PolicyList>
      </PolicySection>
      ...
      <PolicySection title="5. 개인정보처리의 위탁">
        ...
        <PolicyList>
          <li>
            배송 서비스: 배송 업체에 배송에 필요한 최소한의 정보(이름, 전화번호,
            주소) 제공
          </li>
      ...
      <PolicySection title="9. 개인정보 처리방침 변경">
        <p>
          이 개인정보처리방침은 2024년 1월 1일부터 적용되며, 법령 및 방침에 따른
