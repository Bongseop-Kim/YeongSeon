      ...
      <HomeSectionContainer className="grid gap-12 lg:grid-cols-[minmax(280px,0.72fr)_minmax(0,1.28fr)] lg:items-center">
        ...
        >
          ...
          <motion.h2
            ...
            className="font-display mt-4 max-w-md text-3xl font-bold leading-[0.97] tracking-[-0.03em] text-brand-heading lg:text-[4rem]"
          >
            {AI_DESIGN_CONTENT.headline}
          </motion.h2>
          <motion.p
            variants={fadeUpVariants}
            className="mt-4 max-w-md text-base leading-relaxed text-zinc-600"
          >
        ...
        <motion.div
          ...
          viewport={homeViewport}
          variants={fadeUpVariants}
          className="relative overflow-hidden rounded-[var(--radius-showcase-panel)] bg-brand-ink"
        >
          ...
          <div className="grid lg:grid-cols-[minmax(0,1.08fr)_minmax(240px,0.52fr)]">
            ...
            <motion.div
              variants={staggerContainerVariants}
              className="grid gap-px border-t border-white/8 bg-white/8 lg:border-l lg:border-t-0"
            >
              <motion.div
                variants={fadeUpVariants}
                className="bg-brand-paper-muted/96 px-5 py-5 text-brand-heading lg:px-6 lg:py-6"
              >
