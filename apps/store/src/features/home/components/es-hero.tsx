...
export const EsHero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-0 h-40 bg-[linear-gradient(180deg,rgba(18,19,30,0)_0%,rgba(17,20,31,0.52)_42%,rgba(16,20,30,0.94)_100%)] lg:h-52" />
