  ...
  return (
    <section id="brand-story" className="bg-brand-paper-muted py-18 lg:py-24">
      <HomeSectionContainer>
        <div className="relative overflow-hidden rounded-[var(--radius-showcase-panel)] bg-white shadow-[0_25px_80px_rgba(16,18,30,0.06)]">
          ...
          <div className="grid lg:grid-cols-[minmax(0,1.08fr)_minmax(320px,0.82fr)]">
            <div className="relative flex min-h-[420px] flex-col justify-between px-6 py-7 lg:min-h-[520px] lg:px-8 lg:py-8">
              ...
              <div className="relative max-w-[36rem] py-10 lg:py-14">
              ...
              <div className="max-w-sm border-t border-black/8 pt-5">
            ...
            <div className="grid border-t border-black/6 lg:border-l lg:border-t-0">
              <div className="relative min-h-[280px] overflow-hidden bg-brand-paper-muted lg:min-h-[360px]">
                <img
