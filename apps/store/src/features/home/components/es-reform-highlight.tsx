    ...
    <section className="bg-white py-20 lg:py-28">
      <HomeSectionContainer className="grid gap-10 lg:grid-cols-[minmax(280px,0.74fr)_minmax(0,1.26fr)] lg:items-center">
        <div className="lg:pr-8">
          ...
          <h2 className="font-display mt-4 max-w-md text-3xl font-bold leading-[0.97] tracking-[-0.035em] text-brand-heading lg:text-[4.1rem]">
          ...
          >
            <Link to={REFORM_CONTENT.cta.href}>{REFORM_CONTENT.cta.label}</Link>
          </Button>
        </div>

        <div className="relative overflow-hidden rounded-[var(--radius-showcase-panel)] bg-[#f3efe7]">
          ...
          <div className="grid lg:grid-cols-2">
            <div className="relative min-h-[420px] overflow-hidden border-b border-black/6 lg:border-b-0 lg:border-r lg:border-black/6">
              <img
            ...
            <div className="relative min-h-[420px] overflow-hidden bg-brand-surface">
