...
export const MaskCanvas = forwardRef<HTMLCanvasElement, MaskCanvasProps>(
  function MaskCanvas({ baseImageUrl, width, height, onCommit }, forwardedRef) {
    ...
    useImperativeHandle(
      forwardedRef,
      () => maskCanvasRef.current as HTMLCanvasElement,
      [],
    );
