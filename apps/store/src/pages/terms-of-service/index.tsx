...
export default function TermsOfServicePage() {
  return (
    <>
      <PageSeo
        title="이용약관"
        description="영선산업 서비스 이용 조건, 회원 의무, 맞춤 제작·수선·AI 디자인 서비스의 운영 정책을 규정한 이용약관입니다."
        ogUrl="https://essesion.shop/terms-of-service"
      />
      <PolicyPageLayout title="이용약관">
        <PolicySection title="1. 목적">
          <p>
            이 약관은 영선산업(서비스명: ESSE SION, 이하 "회사")이 운영하는
            온라인 쇼핑몰에서 제공하는 서비스(이하 "서비스")의 이용과 관련하여
        ...
        <PolicySection title="5. 회원가입">
          <p>
            이용자는 소셜 계정(Google, Kakao 등)을 통한 간편 가입 방식으로
            회원에 가입할 수 있습니다. 회사는 다음 각 호에 해당하는 경우
            회원가입을 거부할 수 있습니다.
          </p>
          <PolicyList>
            <li>
        ...
        <PolicySection title="6. 회원정보의 변경">
          <p>
            ...
            경우 온라인으로 수정을 하거나 전자우편 기타 방법으로 회사에 대하여
            그 변경사항을 알려야 합니다.
          </p>
        </PolicySection>
        ...
        <PolicySection title="10. 디자인 토큰 서비스 이용">
          ...
          <PolicyList>
            <li>
              유료(paid) 토큰은 패키지 구매를 통해 취득하며, 미사용 잔액에
              한하여 환불 신청이 가능합니다.
            </li>
            <li>
        ...
        <PolicySection title="11. 계약 해지 및 이용 제한">
          <p>
            ...
            회원 탈퇴를 처리합니다. 회사는 회원이 이 약관의 의무를 위반하거나
