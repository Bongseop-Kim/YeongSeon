...
export default function RefundPolicyPage() {
  return (
    <>
      <PageSeo
        title="환불·반품 정책"
        description="영선산업의 상품·맞춤 제작·수선·AI 토큰 환불 기준, 반품 배송비 부담 원칙, 환불 처리 기간을 안내합니다."
      ...
      <PolicyPageLayout title="환불정책">
        <PolicySection title="1. 환불 및 교환 안내">
          <p>
            ...
            최우선으로 생각하며, 구매하신 상품에 문제가 있을 경우 신속하고
            공정한 환불 및 교환을 진행합니다. 단, 상품의 특성상 제작 주문 상품의
            경우 환불 및 교환이 제한될 수 있습니다.
          </p>
        </PolicySection>
        ...
        <PolicySection title="3. 환불 및 교환 불가 사유">
          ...
          <PolicyList>
            ...
            <li>
              맞춤 제작 상품의 경우, 샘플 승인 이후 제작이 진행된 단계에서는
              단순 변심에 의한 취소 및 환불이 불가능합니다.
            </li>
          </PolicyList>
        </PolicySection>
        ...
        <PolicySection title="9. 서비스 유형별 환불 규정">
          ...
          <PolicyList>
            ...
            <li>
              배송 시작 후: 반품 후 환불 (반품 배송비 고객 부담, 상품 하자 시
              회사 부담)
            </li>
        ...
        <PolicySection title="10. AI 디자인 토큰 환불 규정">
          <p>
            AI 디자인 서비스 이용을 위해 구매하는 디자인 토큰의 환불은 다음
            규정에 따릅니다.
          </p>
          <PolicyList>
            <li>
              유료(paid) 토큰: 구매 후 미사용 잔액에 한하여 고객센터를 통해 수동
              환불 신청이 가능합니다. 전자상거래 등에서의 소비자보호에 관한
              법률에 따릅니다.
            </li>
            <li>
            ...
            <li>
              충전된 유료 토큰의 이용기간 및 환불 가능기간은 결제 시점으로부터
              1년 이내로 제한됩니다. 이용기간이 경과한 토큰은 사용 및 환불이
              불가합니다.
            </li>
            <li>
              환불은 결제 시 사용한 수단과 동일한 방법으로만 진행됩니다.
              (신용카드 결제 → 카드 승인 취소, 계좌이체 → 환불 계좌 입금)
            </li>
            <li>
