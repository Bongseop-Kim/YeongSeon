import type { GenerationRouteSignal } from "@/entities/design/model/ai-design-request";
import type { RouteResolverInput } from "@/entities/design/api/resolve-generation-route-types";
...
export const hasEditTarget = (input: RouteResolverInput): boolean =>
