...
const LoginPage = () => {
  ...
  const handleSignInNaver = () => {
    // 네이버 로그인은 빈 함수로 준비만 해둠
    console.log("네이버 로그인 준비 중...");
  };

  const handleSignInIOS = () => {
    // iOS 로그인은 빈 함수로 준비만 해둠
    console.log("iOS 로그인 준비 중...");
  };
          ...
          <div className="w-full max-w-md space-y-8">
            ...
            <div className="space-y-3">
              ...
              <Button
                ...
                disabled={isPending}
                className="w-full h-12 bg-[#FEE500] text-[#000000] hover:bg-[#FEE500]/90 font-medium"
              >
                <svg
              ...
              {/* 네이버 로그인 (준비 중) */}
              <Button
                onClick={handleSignInNaver}
                disabled={isPending}
                className="w-full h-12 bg-[#03C75A] text-white hover:bg-[#03C75A]/90 font-medium"
              >
                <svg
                  className="w-5 h-5 mr-2"
                  viewBox="0 0 24 24"
